    ...
    <>
      ...
      <div style={{ position: "relative", zIndex: 1 }}>
        ...
        <div className={styles.subtitle}>
          ...
          Introducing the Hackiethon, a hackathon catered especially for first-time hackers. Come experience the enjoyment and learning of a hackathon in a beginner-friendly environment!
        </div>
